...
from error_handler import setup_global_exception_hook
...
from utils import setup_environment, resolve_path, log_error
...
def main_flow():
    try:
        ...
        log_error(e)
        st.error(f"Unexpected error in main flow: {str(e)}")
        st.exception(e)
